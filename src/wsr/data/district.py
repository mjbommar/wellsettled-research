# -*- coding: utf-8 -*-
"""
The :mod:`wsr.data.district` handles reading and pre-processing the District
...
# WSR imports
from wsr.config import DISTRICT_FILE_NAME_LIST
...
class District(object):
    ...
    def read_document(self, file_name):
        ...
        """
        # Return the buffer
        return self.district_zip_file.read(file_name)
    ...
    def __init__(self, file_name):
        ...
        # Set District file path
        self.district_zip_path_list = file_name

        # District ZIP file
        self.district_zip_file = zipfile.ZipFile(file_name)

        # District ZIP file list
        self.district_file_list = []

        # District ZIP document list
        self.district_document_list = []
...
if __name__ == "__main__":
    ...
    for file_name in c.district_document_list:
        print(file_name)
